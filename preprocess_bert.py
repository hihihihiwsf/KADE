...
if __name__ == '__main__':
        ...
        for event1 in ecb_star_events:
            for event2 in ecb_star_events:
                ...
                if abs(int(sen_s) - int(sen_t)) == 0: # #
                    ...
                    sentence_s_o = transform_string(sentence_s)
                    sentence_t_o = transform_string(sentence_t)
                    ...
                    span1_o = tokenizer.convert_ids_to_tokens(sentence_vec_s[span1_vec[0]:span1_vec[-1]+1])
                    span2_o = tokenizer.convert_ids_to_tokens(sentence_vec_t[span2_vec[0]:span2_vec[-1]+1])
                    span1_o = transform_string(span1_o)
                    span2_o = transform_string(span2_o)

                    data_set.append([doc, sentence_vec_s, sentence_vec_t, span1_vec, span2_vec, rel, sentence_s_o, sentence_t_o, span1_o, span2_o])
    ...
    print(len(data_set))
    print(data_set[0])
    with open('data_bert_wo.pickle', 'wb') as f:
